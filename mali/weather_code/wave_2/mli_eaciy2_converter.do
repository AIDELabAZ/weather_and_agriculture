...
* does
	* reads in Mali, wave 2 .csv files
...
* define paths
	loc root = "$data/weather_data/mali/wave_2/raw/eaciy2_up"
	loc export = "$data/weather_data/mali/wave_2/daily/eaciy2_up"
	loc logout = "$data/weather_data/mali/logs"

* open log
	cap log		close
	log using "`logout'/mli_eaciy2_converter", replace
