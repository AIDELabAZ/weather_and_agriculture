...
* does
	* reads in Mali, wave 1 .dta files with daily values
...
* define paths	
	loc root = "$data/weather_data/mali/wave_1/daily/eaciy1_up"
	loc export = "$data/weather_data/mali/wave_1/refined/eaciy1_up"
	loc logout = "$data/weather_data/mali/logs"

* open log	
	cap log		close
	log using "`logout'/mli_eaciy1_weather", replace
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2014
		keep uid rf_19830101-rf_20150101
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2014
		keep uid tmp_19830101-tmp_20150101
