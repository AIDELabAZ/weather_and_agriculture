...
* import the daily ARC2 data file
	use "`root'/ihs4p_arc2_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_arc2.dta", replace

* import the daily CHIRPS data file
	use "`root'/ihs4p_chirps_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_chirps.dta", replace
...
* import the daily TAMSAT data file
	use "`root'/ihs4p_tamsat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_tamsat.dta", replace
...
* import the daily CPC TP data file
	use "`root'/ihs4p_cpct_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_cpct.dta", replace

* import the daily ERA5 TP data file
	use "`root'/ihs4p_erat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_erat.dta", replace

* import the daily MERRA-2 TP data file
	use "`root'/ihs4p_merrat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs4p_merrat.dta", replace
