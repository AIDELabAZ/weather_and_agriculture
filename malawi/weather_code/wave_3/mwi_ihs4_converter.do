...
* define paths
	loc 		root 	= 	"$data/weather_data/malawi/wave_3/raw/ihs4_up"
	loc 		export 	= 	"$data/weather_data/malawi/wave_3/daily/ihs4_up"
	loc 		logout 	= 	"$data/weather_data/malawi/logs"

* open log
	cap log		close
	log 		using 		"`logout'/mwi_ihs4_converter", append
...
* loop through each file in the above local
	...
	* drop early and late observations
		keep 	case_id rf_19831031-rf_20160531
...
* loop through each file in the above local
	...
	* drop early and late observations
		keep 	case_id tmp_19831031-tmp_20160531
