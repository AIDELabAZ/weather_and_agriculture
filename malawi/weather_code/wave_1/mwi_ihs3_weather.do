...
* import the daily ARC2 data file
	use "`root'/ihs3_arc2_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_arc2.dta", replace

* import the daily CHIRPS data file
	use "`root'/ihs3_chirps_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_chirps.dta", replace
...
* import the daily TAMSAT data file
	use "`root'/ihs3_tamsat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_tamsat.dta", replace
...
* import the daily CPC TP data file
	use "`root'/ihs3_cpct_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_cpct.dta", replace

* import the daily ERA5 TP data file
	use "`root'/ihs3_erat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_erat.dta", replace

* import the daily MERRA-2 TP data file
	use "`root'/ihs3_merrat_daily.dta", clear
	...
	* save file
		save			"`export'/ihs3_merrat.dta", replace
