...
* does
	* reads in Malawi IHS5p, which we term wave 6, .csv files
...
* define paths
	loc 		root 	= 	"$data/weather_data/malawi/wave_6/raw/ihs5p_up"
	loc 		export 	= 	"$data/weather_data/malawi/wave_6/daily/ihs5p_up"
	loc 		logout 	= 	"$data/weather_data/malawi/logs"

* open log
	cap log		close
	log 		using 		"`logout'/mwi_ihs5p_converter", append
...
* loop through each file in the above local
	...
	* drop early and late observations
		keep 	y4_hhid rf_19831031-rf_20190531
...
* loop through each file in the above local
	...
	* drop early and late observations
		keep 	y4_hhid tmp_19831031-tmp_20190531
