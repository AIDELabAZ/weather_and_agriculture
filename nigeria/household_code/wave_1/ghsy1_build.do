...
* define paths
	global			rootw 	= 	"$data/weather_data/nigeria/wave_1/refined/ghsy1_up"
	global			rooth 	= 	"$data/household_data/nigeria/wave_1/refined"
	global			export 	= 	"$data/merged_data/nigeria/wave_1"
...
* save file
	qui: compress
	save 			"$export/ghsy1_merged_n.dta", replace
...
* save file
	qui: compress
	save 			"$export/ghsy1_merged_s.dta", replace
...
* save file
	save 			"$export/ghsy1_merged.dta", replace
