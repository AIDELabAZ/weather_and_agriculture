...
* does
	* merges weather data into GHSY4 household data
...
* define paths
	global			rootw 	= 	"$data/weather_data/nigeria/wave_4/refined/ghsy4_up"
	global			rooth 	= 	"$data/household_data/nigeria/wave_4/refined"
	global			export 	= 	"$data/merged_data/nigeria/wave_4"
	global			logout 	= 	"$data/merged_data/nigeria/logs"

* open log	
	cap	log 		close
	log 			using 		"$logout/ghsy4_build", append
...
* import the .dta houeshold file
	use 		"$rooth/hhfinal_ghsy4.dta", clear
...
* save file
	qui: compress
	save 			"$export/ghsy4_merged_n.dta", replace
...
* save file
	qui: compress
	save 			"$export/ghsy4_merged_s.dta", replace
...
* import northern data
	use 		"$export/ghsy4_merged_n.dta", clear

* append southern data
	append		using "$export/ghsy4_merged_s.dta", force
...
* save file
	save 			"$export/ghsy4_merged.dta", replace

* erase northern and southern files
	erase		"$export/ghsy4_merged_n.dta"
	erase		"$export/ghsy4_merged_s.dta"
