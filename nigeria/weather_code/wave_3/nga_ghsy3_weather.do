...
* define paths	
	loc 		root = "$data/weather_data/nigeria/wave_3/daily/ghsy3_up"
	loc 		export = "$data/weather_data/nigeria/wave_3/refined/ghsy3_up"
	loc 		logout = "$data/weather_data/nigeria/logs"

* open log	
	cap log		close
	log using "`logout'/nga_ghsy3_weather", append
