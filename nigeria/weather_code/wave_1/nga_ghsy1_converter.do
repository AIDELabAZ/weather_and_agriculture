...
* define paths
	loc 		root = "$data/weather_data/nigeria/wave_1/raw/ghsy1_up"
	loc 		export = "$data/weather_data/nigeria/wave_1/daily/ghsy1_up"
	loc 		logout = "$data/weather_data/nigeria/logs"

* open log
	cap log		close
	log using 	"`logout'/nga_ghsy1_converter", append
