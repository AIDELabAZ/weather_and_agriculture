...
* define paths
	loc 		root = "$data/weather_data/nigeria/wave_2/raw/ghsy2_up"
	loc 		export = "$data/weather_data/nigeria/wave_2/daily/ghsy2_up"
	loc 		logout = "$data/weather_data/nigeria/logs"

* open log
	cap log		close
	log using 	"`logout'/nga_ghsy2_converter", append
