...
* does
	* cleans Ethiopia household variables, wave 5 HH sec1
...
* open log	
	cap log 	close
	log 		using			"$logout/wv5_HHSEC1", append

	
* **********************************************************************
* 1 - preparing ESS 2021/22 (Wave 5) - Household Section 1 
* **********************************************************************

* load data
	use 		"$root/sect1_hh_w5.dta", clear
