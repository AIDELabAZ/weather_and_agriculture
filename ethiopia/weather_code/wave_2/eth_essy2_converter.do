...
* define paths
	loc root = "$data/weather_data/ethiopia/wave_2/raw"
	loc export = "$data/weather_data/ethiopia/wave_2/daily"
...
* define local with all sub-folders in it
	loc folderList : dir "`export'" dirs "ESSY2_rf*"
...
foreach folder of local folderList {
	...
	* define local with all files in each sub-folder	
		loc fileList : dir "`export'/`folder'" files "*.csv"
