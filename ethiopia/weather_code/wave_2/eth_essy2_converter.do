...
* define paths
	loc root = "$data/weather_data/ethiopia/wave_2/raw/essy2_up"
	loc export = "$data/weather_data/ethiopia/wave_2/daily/essy2_up"
	loc logout = "$data/weather_data/ethiopia/logs"

* open log
	cap log		close
	log using "`logout'/eth_essy2_converter", append
