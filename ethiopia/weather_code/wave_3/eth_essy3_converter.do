...
* define paths
	loc root = "$data/weather_data/ethiopia/wave_3/raw/essy3_up"
	loc export = "$data/weather_data/ethiopia/wave_3/daily/essy3_up"
	loc logout = "$data/weather_data/ethiopia/logs"

* open log
	cap log		close
	log using "`logout'/eth_essy3_converter", append
