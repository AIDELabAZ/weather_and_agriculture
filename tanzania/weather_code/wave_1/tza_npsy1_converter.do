...
* define paths
	loc			root 	=	"$data/weather_data/tanzania/wave_1/raw/npsy1_up"
	loc			export	=	"$data/weather_data/tanzania/wave_1/daily/npsy1_up"
	loc			logout	=	"$data/weather_data/tanzania/logs"

* open log
	cap log		close
	log			using	"`logout'/tza_npsy1_converter", append
...
* loop through each file in the above local
	...
	* drop early and late observations (2009)
		keep 	hhid rf_19831101-rf_20090531
...
* loop through each file in the above local	
	foreach file in `fileList' {
		...
		* drop early and late observations (2009)
		keep 	hhid tmp_19831101-tmp_20090531
