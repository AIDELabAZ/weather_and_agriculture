...
* do each of the file converters
	...
	do "`root'/wave_5/TZA_NPSY5_converter.do"	//	convert wave 5 .csv to .dta
	do "`root'/wave_6/TZA_NPSY6_converter.do"	//	convert wave 6 .csv to .dta
...
* do each of the weather commands
	...
	do "`root'/wave_5/TZA_NPSY5_weather.do"		//	generate wave 5 weather variables
	do "`root'/wave_6/TZA_NPSY6_weather.do"		//	generate wave 6 weather variables
