...
* define paths	
	loc 		root 	= 	"$data/weather_data/tanzania/wave_2/daily/npsy2_up"
	loc 		export 	= 	"$data/weather_data/tanzania/wave_2/refined/npsy2_up"
	loc 		logout 	= 	"$data/weather_data/tanzania/logs"

* open log	
	cap log		close
	log using 	"`logout'/tza_npsy2_weather", append
