...
* define paths	
	loc 		root 	= 	"$data/weather_data/tanzania/wave_3/daily/npsy3_up"
	loc 		export 	= 	"$data/weather_data/tanzania/wave_3/refined/npsy3_up"
	loc 		logout 	= 	"$data/weather_data/tanzania/logs"

* open log	
	cap log		close
	log using 	"`logout'/tza_npsy3_weather", append
