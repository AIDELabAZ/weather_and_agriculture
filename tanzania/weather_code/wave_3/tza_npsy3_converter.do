...
* define paths
	loc			root	=	"$data/weather_data/tanzania/wave_3/raw/npsy3_up"
	loc			export	=	"$data/weather_data/tanzania/wave_3/daily/npsy3_up"
	loc			logout	=	"$data/weather_data/tanzania/logs"

* open log
	cap log		close
	log			using	"`logout'/tza_npsy3_converter", append
...
* loop through each file in the above local
	foreach file in `fileList' {
		...
		* drop early and late observations (2013)
		keep 	y3_hhid rf_19831101-rf_20130531
...
* loop through each file in the above local	
	foreach file in `fileList' {
		...
		* drop early and late observations (2013)
		keep 	y3_hhid tmp_19831101-tmp_20130531
