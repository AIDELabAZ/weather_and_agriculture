...
* does
	* reads in Tanzania, wave 5 which we call wave 7 .csv files
...
* define paths
	loc			root	=	"$data/weather_data/tanzania/wave_7/raw/npsy5_up"
	loc			export	=	"$data/weather_data/tanzania/wave_7/daily/npsy5_up"
