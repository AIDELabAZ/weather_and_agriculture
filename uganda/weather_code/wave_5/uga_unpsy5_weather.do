...
* does
	* reads in Uganda, wave 5 .dta files with daily values
...
* define paths	
	loc 		root 	= "$data/weather_data/uganda/wave_5/daily/unpsy5_up"
	loc 		export 	= "$data/weather_data/uganda/wave_5/refined/unpsy5_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log	
	cap log		close
	log using 	"`logout'/uga_unpsy5_weather", replace
