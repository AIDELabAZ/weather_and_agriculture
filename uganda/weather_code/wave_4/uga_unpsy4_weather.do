...
* does
	* reads in Uganda, wave 4 .dta files with daily values
...
* define paths	
	loc 		root 	= "$data/weather_data/uganda/wave_4/daily/unpsy4_up"
	loc 		export 	= "$data/weather_data/uganda/wave_4/refined/unpsy4_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log	
	cap log		close
	log using 	"`logout'/uga_unpsy4_weather", replace
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2013
		keep hhid rf_19830101-rf_20131231
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2013
		keep hhid tmp_19830101-tmp_20131231
