...
* define paths
	loc 		root 	= "$data/weather_data/uganda/wave_1/raw/unpsy1_up"
	loc 		export 	= "$data/weather_data/uganda/wave_1/daily/unpsy1_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log
	cap log		close
	log using 	"`logout'/uga_unpsy1_converter", append
