...
* does
	* reads in Uganda, wave 8 .dta files with daily values
...
* define paths	
	loc 		root 	= "$data/weather_data/uganda/wave_8/daily/unpsy8_up"
	loc 		export 	= "$data/weather_data/uganda/wave_8/refined/unpsy8_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log	
	cap log		close
	log using 	"`logout'/uga_unpsy8_weather", replace
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2019
		keep hhid rf_19830101-rf_20191231
...
* loop through each file in the above local
	...
	* drop weather variables beyond 2019
		keep hhid tmp_19830101-tmp_20191231
