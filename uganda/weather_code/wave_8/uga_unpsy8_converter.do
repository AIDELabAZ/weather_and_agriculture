...
* does
	* reads in Uganda, wave 8 .csv files
...
* define paths
	loc 		root 	= "$data/weather_data/uganda/wave_8/raw/unpsy8_up"
	loc 		export 	= "$data/weather_data/uganda/wave_8/daily/unpsy8_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log
	cap log		close
	log using 	"`logout'/uga_unpsy8_converter", append
