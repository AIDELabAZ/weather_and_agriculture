...
* does
	* reads in Uganda, wave 7 .dta files with daily values
...
* define paths	
	loc 		root 	= "$data/weather_data/uganda/wave_7/daily/unpsy7_up"
	loc 		export 	= "$data/weather_data/uganda/wave_7/refined/unpsy7_up"
	loc 		logout 	= "$data/weather_data/uganda/logs"

* open log	
	cap log		close
	log using 	"`logout'/uga_unpsy7_weather", replace
